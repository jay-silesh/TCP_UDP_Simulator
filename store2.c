...
/* PORT NOs FOR THE STORE2  TO USE AND SEND */
char port_read[2][100]={"9350","11350"};
char port_write[2][100]={"13350","15350"};
char port_self[2][100]={"10350","12350"};
...
int main(int argc, char *argv[])
{
	...
	//printf("\n\nThe Data is initially in the Client Side is\nCamera %d\nLaptop %d\nPrinter %d\n",ele.camera,ele.laptop,ele.printer);
	...
	printf("\nPhase 1: store_2 has TCP port number %d and IP address %s",sock_to_port(sockfd),s);
	...
	/* the files that should be opened for the store2 */
	FILE *fd;
	fd = fopen("Store-2.txt", "r");
	if (fd == NULL)
	{
	...
	printf("\nPhase 1: The outlet vector<%d,%d,%d> for store_2 has been sent to the central warehouse",ele.camera,ele.laptop,ele.printer);
...
while(comp_counter!=2)
{
   ...
   printf("\nPhase 2: Store_2 has UDP port %d and IP address %s",sock_to_port(sockfd),s1);
	...
	printf("\nPhase 2: Store_2 received the truck-vector<%d,%d,%d> from the Store_1",temp_ele->camera,temp_ele->laptop,temp_ele->printer);
...
/*					sending the truck vector to the second client...										 */
	...
	printf("\nPhase 2: Store_2 has UDP port %d and IP address %s",sock_to_port(sockfd),s2);
	printf("\nPhase 2: The updated truck-vector<%d,%d,%d> has been sent to store_3",temp_ele->camera,temp_ele->laptop,temp_ele->printer);
	printf("\nPhase 2: Store_2 updated outlet-vector is <%d,%d,%d>",ele.camera,ele.laptop,ele.printer);
